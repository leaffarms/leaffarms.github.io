const PRODUCE_IMAGES = {
	"a-choy": {
		name: "A-Choy",
		source: "images/produce/a-choy.jpg",
	...
	"american_okra": {
		name: "American Okra",
		source: "images/produce/american_okra.jpg",
	...
	"baby_bok_choy": {
		name: "Baby Bok Choy",
		source: "images/produce/baby_bok_choy.jpg",
	...
	"cabbage": {
		name: "Cabbage",
		source: "images/produce/cabbage.jpg",
	...
	"cayan": {
		name: "Cayan",
		source: "images/produce/cayan.jpg",
	...
	"chinese_eggplant": {
		...
		source: "images/produce/chinese_eggplant.jpg",
	...
	"chinese_okra": {
		name: "Chinese Okra",
		source: "images/produce/chinese_okra.jpg",
	...
	"cilantro": {
		name: "Cilantro",
		source: "images/produce/cilantro.jpg",
	...
	"coconut": {
		name: "Coconut",
		source: "images/produce/coconut.jpg",
		thumbnail: "images/produce/coconut_thumb.jpg",
		category: "",
		alt: "",
	},
	"culantro": {
	...
	"dragon_fruit": {
		name: "Dragon Fruit",
		source: "images/produce/dragon_fruit.jpg",
	...
	"gobo": {
		name: "Gobo",
		source: "images/produce/gobo.jpg",
	...
	"habanero": {
		name: "Habanero",
		source: "images/produce/habanero.jpg",
	...
	"jicama": {
		name: "Jicama",
		source: "images/produce/jicama.jpg",
	...
	"kohlrabi": {
		name: "Kohlrabi",
		source: "images/produce/kohlrabi.jpg",
	...
	"lemongrass": {
		name: "Lemongrass",
		source: "images/produce/lemongrass.jpg",
	...
	"malanga_edo": {
		name: "Malanga_edo",
		source: "images/produce/malanga_edo.jpg",
	...
	"montoy": {
		name: "Montoy",
		source: "images/produce/montoy.jpg",
	...
	"potato_leaf": {
		name: "Potato Leaf",
		source: "images/produce/potato_leaf.jpg",
	...
	"pumpkin": {
		name: "Pumpkin",
		source: "images/produce/pumpkin.jpg",
	...
	"rambutan": {
		name: "Rambutan",
		source: "images/produce/rambutan.jpg",
	...
	"shallot": {
		name: "Shallot",
		source: "images/produce/shallot.jpg",
	...
	"snow_peas": {
		name: "Shallot",
		source: "images/produce/snow_peas.jpg",
	...
	"sugar_apple": {
		name: "Sugar Apple",
		source: "images/produce/sugar_apple.jpg",
	...
	"sugar_snap": {
		name: "Sugar Snap",
		source: "images/produce/sugar_snap.jpg",
	...
	"thai_banana": {
		name: "Thai Banana",
		source: "images/produce/thai_banana.jpg",
	...
	"thai_ginger_(galanga)": {
		name: "Thai Eggplant",
		source: "images/produce/thai_ginger_(galanga).jpg",
	...
	"thai_okra": {
		name: "Thai Okra",
		source: "images/produce/thai_okra.jpg",
	...
	"winter_melon": {
		name: "Winter Melon",
		source: "images/produce/winter_melon.jpg",
	...
	"yuca": {
		name: "Yuca",
		source: "images/produce/yuca.jpg",
	...
	"yuca_leaf": {
		name: "Yuca Leaf",
		source: "images/produce/yuca_leaf.jpg",
